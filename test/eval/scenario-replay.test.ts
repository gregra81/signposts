...
//
// Graded on operations and mirror size, never on the classification kind. The
// kind is the model's judgement, recorded in the fixture; asserting it would
// reward editing a transcript until the model agreed with its label.
//
...
import type { Operation } from "../../src/core/contracts/graph.ts";
